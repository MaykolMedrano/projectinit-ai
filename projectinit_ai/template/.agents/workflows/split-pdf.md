---
description: Comando para extraer la metodología y resultutilities de PDFs completos usando la API de Gemini 2.5 Flash.
---
...
5. El sistema detecta papers ya procesutilities para no gastar cuota de API (caché).
...
- Datos y Fuentes
- Resultutilities y Magnitudes Principales (Números Duros)
