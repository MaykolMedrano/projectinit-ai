...
Usado por el **Crítico Causal** para auditar diseños basutilities en matching y propensity score.
...
- [ ] Gráfico de distribución del propensity score para tratutilities y controles
...
- [ ] ¿Hay suficientes controles para el matching (ratio tratutilities/controles)?
