...
├── 04_literature/         # Papers descargutilities y Notas autogeneradas con IA
├── 05_doc/                # Manuscrito, presentaciones y estilos (.sty)
├── 06_admin/              # Protocolos de réplica (REPD.md), Ética e IRB
├── .agents/               # "El Cerebro": Checklists Causal/Code y Workflows de IA
├── .gitignore             # Control de versiones del laboratorio
...
El repositorio incluye un script especializado en `02_scripts/utilities/gemini_lit_extractor.py`. Utilizando la ventana de contexto de **Gemini 2.5 Flash**, este script inyectará cientos de páginas de un PDF en milisegundos y devolverá un resumen metodológico en la carpeta `04_literature/reading_notes`.
...
3. Ejecuta:
   ...
   ```bash
   python 02_scripts/utilities/gemini_lit_extractor.py
   ```
...
**Paso 1: Inicializa tu Investigación**
Usa el comando `projectinit-ai` desde tu terminal para desplegar esta estructura en cualquier carpeta nueva.
