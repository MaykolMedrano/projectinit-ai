...
from ados.aer_style import AERTable
...
# Usamos linearmodels o creamos dummies (dado que son simulados y N es pequeño, uso dummies aqui, pero en la practica linearmodels/reghdfe)
try:
