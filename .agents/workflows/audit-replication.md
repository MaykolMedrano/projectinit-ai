...
3. Asegura que se cumplan las 4 leyes de la AEA Data and Code Availability Policy:
   ...
   - **Code:** Todos los archivos `.do` o `.py` que producen las figuras y tablas del paper están comentados e interconectados mediante un archivo maestro (ej. `02_scripts/run_all.do`).
